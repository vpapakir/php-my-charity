...
$this->params['breadcrumbs'][] = ['label' => 'Volunteer', 'url' => ['index']];
   ...
   <hr/>
				...
				<!-- Left Starts -->
                    ...
                    <?php $form = ActiveForm::begin(['options' => ['enctype' => 'multipart/form-data']]); ?>
							...
							<img src="<?= Yii::getAlias('@web'); ?>/ProfilePic/volunteer/<?=$image?>" alt="Image" class="img-responsive thumbnail" width="200" />
...
{
	$('#w0').attr('action','<?= Yii::getAlias('@web'); ?>/volunteer/profile/profile-pic?id='+id);
	$('#w0').submit();
}
