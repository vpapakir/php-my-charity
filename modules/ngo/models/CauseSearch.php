...
/**
 * CauseSearch represents the model behind the search form about `app\modules\admin\models\Cause`.
 */
class CauseSearch extends Cause
{
    ...
    {
        return [
            [['CauseId', 'NgoName', 'RegisterBy', 'Reason','PrimaryArea'], 'integer'],
    ...
    public function search($params)
    {
      $user = Yii::$app->user->identity;
	    $query = Cause::find()->where(['RegisterBy'=>$user->id]);
