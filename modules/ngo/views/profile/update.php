...
$this->title = 'Edit Profile: ' . ' ' . $model->NgoName;
$this->params['breadcrumbs'][] = ['label' => 'Ngo', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => $model->NgoName, 'url' => ['../profile']];
   ...
   <hr/>
				...
				<!-- Left Starts -->
                    ...
                    <?php $form = ActiveForm::begin(['options' => ['enctype' => 'multipart/form-data']]); ?>
							...
							<img src="<?= Yii::getAlias('@web'); ?>/ProfilePic/ngo/<?=$image?>" alt="Image" class="img-responsive thumbnail" width="200" />
...
{
	$('#w0').attr('action','<?= Yii::getAlias('@web'); ?>/ngo/profile/profile-pic?id='+id);
	$('#w0').submit();
}
